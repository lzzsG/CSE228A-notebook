    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'L10 Testing (cont.) + FP Intro', link: '/L10-Functional-Programming-Primer' },
          { text: 'L11 FP (cont.)', link: '/L11-Functional-Programming-continued' },
          { text: 'L12 FP (conc.) + Pattern Matching', link: '/L12-FP-Conclusion-Pattern-Matching' },
          ...
          { text: 'L16 Design Opt. Intro + Memory', link: '/L16-Intro-to-Design-Optimization-Memory' },
          ...
          { text: 'Guest Lecture - Kevin Laeufer - Formal Verification in Chisel', link: 'L22-Formal-Verification' },
          { text: 'L18 Optimizing Delay', link: '/L18-Optimizing-for-Delay' },
